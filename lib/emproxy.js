        ...
        requestDomain.run(function() {
            ...
            processDirective(requestData,function(err,responseData){
                if(err) {
                    ...
                    var RestResponse = {targetType:'RestResponse',status:'ERROR',errors:[]};
                    RestResponse.errors.push({targetType:'CdmError',errorCode:err.errorCode,errorMessage:err.message,badRequest:postData,err:err})
                    response.end(JSON.stringify(RestResponse, null, '\t')+'\n');
                } else {
                    ...
                    // DEBUG: console.log(util.inspect(responseData,false,null));
